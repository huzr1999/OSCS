...
class BadNetsPoisoner(Poisoner):
    ...
    def __init__(
        self, 
        badnets_triggers: Optional[List[str]] = ["cf", "mn", "bb", "tq"],
        num_triggers: Optional[int] = 1,
        **kwargs
    ):
        super().__init__(**kwargs)
        
        self.triggers = badnets_triggers
        self.num_triggers = num_triggers
        # self.logger.info("Initializing BadNet poisoner, triggers are {}".format(" ".join(self.triggers)))
